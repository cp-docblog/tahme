...
import styles from './TtAdsList.module.css';
...
interface TtAdsListProps {
    advertiserId: string;
    adgroupId: string;
    onSelectAd?: (ad: Ad) => void;
}

export const TtAdsList: React.FC<TtAdsListProps> = ({ advertiserId, adgroupId, onSelectAd }) => {
    ...
    }, [adgroupId, dateRange.start, dateRange.end]);
    ...
    const fetchAds = async () => {
        ...
        try {
            const { data, error: fnError } = await supabase.functions.invoke('tt-ads', {
                body: {
            ...
            console.error('Error fetching TikTok ads:', err);
    ...
    const fetchMediaPreviews = async (adsList: Ad[]) => {
        ...
        try {
            ...
            const { data, error } = await supabase.functions.invoke('tt-media', {
                body: {
                    advertiser_id: advertiserId,
                    ad_ids: adIds,
                },
