...
import styles from './TtCampaignsList.module.css';
...
interface TtCampaignsListProps {
    clientId: string;
    advertiserId: string;
    onSelectCampaign: (campaign: Campaign) => void;
}

export const TtCampaignsList: React.FC<TtCampaignsListProps> = ({
    clientId,
    advertiserId,
    onSelectCampaign
}) => {
    ...
    }, [advertiserId, dateRange.start, dateRange.end]);
    ...
    const fetchCampaigns = async () => {
        ...
        try {
            const { data, error: fnError } = await supabase.functions.invoke('tt-campaigns', {
                body: {
