...
import styles from './FbCampaignsList.module.css';
...
interface FbCampaignsListProps {
    clientId: string;
    adAccountId: string;
    accessToken: string;
...
export const FbCampaignsList: React.FC<FbCampaignsListProps> = ({
    clientId,
    adAccountId,
    accessToken,
    onSelectCampaign
    ...
    }, [adAccountId, accessToken, dateRange.start, dateRange.end]);
    ...
    const fetchCampaigns = async () => {
        ...
        try {
            const { data, error: fnError } = await supabase.functions.invoke('fb-campaigns', {
                body: {
