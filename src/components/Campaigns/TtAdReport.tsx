...
import styles from './TtAdReport.module.css';

interface TtAdReportProps {
    adId: string;
    adName: string;
    advertiserId: string;
}

export const TtAdReport: React.FC<TtAdReportProps> = ({ adId, adName, advertiserId }) => {
    ...
    const fetchMediaPreview = async () => {
        ...
        try {
            ...
            console.log('tt-media response:', { data, error });
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            console.error('Error fetching TikTok ad report:', err);
